INSERT INTO Path (num, starting_point, end_point, est_arrival, starting_date, id_ruta, status) VALUES 
(1, 'WH001', 'Client 1', '2024-11-01', '2024-10-15', 1, 'Not Started'),
(2, 'WH002', 'Client 2', '2024-11-03', '2024-10-16', 2, 'Not Started'),
(3, 'WH003', 'Client 3', '2024-11-05', '2024-10-17', 3, 'Not Started');
...
INSERT INTO Stock (code, name, amount, description, warehouse) VALUES
('ST001', 'Screw M4', 15000, '4mm diameter screws', 'WH001'),
('ST002', '12mm Washer', 25000, 'Washers for bolts and screws', 'WH002'),
('ST003', 'Hex Nut M5', 20000, '5mm hexagonal nuts', 'WH003'),
('ST004', 'Industrial Lubricant', 8000, 'Lubricant for machinery', 'WH004'),
('ST005', 'Air Filter', 12000, 'Filters for air systems', 'WH005'),
('ST006', 'Adhesive Tape', 30000, 'Strong adhesive tape', 'WH001'),
('ST007', 'Cardboard Box', 5000, 'Packaging boxes', 'WH002'),
('ST008', 'Bubble Wrap', 4500, 'Protective packaging material', 'WH003'),
('ST009', 'Wooden Pallet', 1000, 'Pallets for transportation', 'WH004'),
('ST010', 'Steel Plate', 800, 'Plates made of stainless steel', 'WH005'),
('ST011', 'Spring', 750, 'Coiled metal springs', 'WH001'),
('ST012', 'V Belt', 1500, 'Drive belts for motors', 'WH002'),
('ST013', 'Wheel 5in', 500, '5-inch wheels for carts', 'WH003'),
('ST014', '20T Gear', 1200, '20-tooth gear', 'WH004'),
('ST015', 'PVC Tube', 300, 'PVC tubing for plumbing', 'WH005'),
('ST016', 'LED Panel', 200, 'Lighting panels', 'WH001'),
('ST017', 'Switch', 10000, 'Electrical switches', 'WH002'),
('ST018', '10m Cable', 5000, '10-meter electrical cables', 'WH003'),
('ST019', 'Bearing', 3000, 'Ball bearings', 'WH004'),
('ST020', 'Clamp', 1500, 'Metal clamps', 'WH005'),
('ST021', '8mm Drill', 7000, '8mm drill bits', 'WH001'),
('ST022', '90° Elbow', 3500, 'Elbows for piping', 'WH002'),
('ST023', 'Manometer', 800, 'Pressure measurement device', 'WH003'),
('ST024', 'Hydraulic Oil', 6000, 'Oil for hydraulic systems', 'WH004'),
('ST025', 'Screw M6', 18000, '6mm diameter screws', 'WH005'),
('ST026', 'Thermal Glove', 2500, 'Gloves for high temperatures', 'WH001'),
('ST027', 'Water Filter', 5000, 'Filters for water systems', 'WH002'),
('ST028', 'RJ45 Connector', 20000, 'Connectors for network cables', 'WH003'),
('ST029', 'USB Adapter', 1500, 'Adapters for USB devices', 'WH004'),
('ST030', 'Solar Panel', 200, 'Panels for solar energy', 'WH005'),
('ST031', 'Industrial Fan', 800, 'Fans for industrial cooling', 'WH001'),
('ST032', '12V Battery', 1200, '12-volt batteries', 'WH002'),
('ST033', 'Circular Saw', 400, 'Saws for cutting wood or metal', 'WH003'),
('ST034', 'Nylon Rope', 7500, 'Strong nylon ropes', 'WH004'),
('ST035', 'Copper Wire', 6000, 'Wires made of copper', 'WH005');

INSERT INTO Incident (num, title, description, status, date_incident, date_report, user) VALUES 
(1, 'Traffic Delay', 'Delivery delay due to traffic', 'close', '2024-10-09', '2024-10-10 08:30:00', 1),
(2, 'Damaged Product', 'Damaged product during shipment', 'open', '2024-10-10', '2024-10-11 09:00:00', 2),
(3, 'Route Change', 'Route changed due to roadwork', 'close', '2024-10-12', '2024-10-12 10:15:00', 3),
(4, 'Cargo Security Issue', 'Security incident with the cargo', 'open', '2024-10-13', '2024-10-13 11:45:00', 4),
(5, 'Vehicle Failure', 'Mechanical failure of vehicle', 'close', '2024-10-14', '2024-10-14 07:00:00', 5),
(6, 'Address Error', 'Error in delivery address', 'open', '2024-10-15', '2024-10-15 06:50:00', 6),
(7, 'Customs Delay', 'Customs delay', 'close', '2024-10-16', '2024-10-16 08:20:00', 7),
(8, 'Documentation Problem', 'Documentation issues', 'open', '2024-10-17', '2024-10-17 09:35:00', 8),
(9, 'Packaging Issue', 'Poorly packaged product', 'close', '2024-10-18', '2024-10-18 10:05:00', 9),
(10, 'Client Change', 'Last-minute client change', 'open', '2024-10-19', '2024-10-19 12:30:00', 10),
(11, 'Weather Conditions', 'Adverse weather conditions', 'open', '2024-10-30', '2024-10-30 14:00:00', 11);
...
INSERT INTO RutaDetalles (ruta, id_vehiculo, fecha, orden_entrega, status, id_paquete, direccion_destino, id_ruta)
VALUES 
    (1, 1, '2024-10-29', 1, 'Pending', 1, 'Av. Siempre Viva 742, Springfield', 1),
    (2, 2, '2024-10-30', 2, 'Pending', 2, 'Calle Falsa 123, Springfield', 2),
    (4, 3, '2024-10-31', 4, 'Pending', 4, 'Paseo de la Reforma 100, Ciudad de México', 3);